...
def verify_envelope(envelope: dict, public_key: bytes, *, payload_type: Optional[str] = None) -> bool:
    ...
    malformed, non-canonical or low-order key verifies nothing: under such a key a fixed signature is
    valid for every payload with no private key. Deep gate Z195, L1-Z195-03: `decision verify --pub`
