...
AUTOMATION_BLOCKER_REASONS = {
    ...
    # relation/v0.1 (EXPERIMENTAL): raised by the decision/outcome verify paths when the trust
    # policy's relations section is violated (a named relation did not resolve, or an attached,
