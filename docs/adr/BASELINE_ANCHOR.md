...
| Witness quorum (freshness) | `checkpoint.py::witness_quorum` | k-of-n distinct witness KEY MATERIAL, ML-DSA + Ed25519 alg-agnostic; a signature under the checked log's own origin name never counts (origin-quorum rule, 2026-08-17) |
