...
21 entries, 13 closed, 8 open, **0 open P0/P1** (counted, not quoted). That register, not any prose
...
| findings register, 0 open P0/P1 | PASS via C12.2 — 21 findings evaluated from the signed, version-bound register (`6.0.0`), anchor key authorised, measured 2026-09-06 |
