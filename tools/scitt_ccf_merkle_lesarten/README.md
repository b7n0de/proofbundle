...
| caveat | An IANA Expert Review of **-04** was posted to the SCITT list on 2026-09-12 raising **five blocking findings**, with the recommendation not to complete the registration on -04. This measurement is therefore of a draft whose registration is contested. It says what the two readings compute; it does not say which reading the working group will adopt. |
